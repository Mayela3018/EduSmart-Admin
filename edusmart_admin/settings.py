...
INSTALLED_APPS = [
    # Django admin theme (debe ir ANTES de django.contrib.admin)
    #'admin_interface',
    #'colorfield',
...
ROOT_URLCONF = 'edusmart_admin.urls'
...
# Database - CONEXIÓN A LA MISMA BD DE SPRING BOOT
# IMPORTANTE: Django NO creará ni modificará las tablas existentes
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'productivity_db'),
...
# CORS Settings (para React frontend)
